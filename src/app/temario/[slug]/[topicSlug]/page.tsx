...
import { BookOpen, ExternalLink, ChevronLeft, ChevronRight, Film, Globe, Brain, Sparkles } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative mb-8 overflow-hidden rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 p-8 text-white shadow-xl"
      >
